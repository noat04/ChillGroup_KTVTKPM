...
export function ProductListPage({ products, addToCart, loadProducts, setMessage }) {
        ...
        <section className="home-section">
          ...
          <section className="products">
            {aiResults.map((product) => (
              <ProductCard key={`ai-${product.id || product.productId}`} product={product} addToCart={addToCart} />
            ))}
          </section>
        </section>
      ) : null}
